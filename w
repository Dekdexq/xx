...
local Library do 
    ...
    do 
        ...
        Library.Notification = function(self, Data)
            local Items = { } do 
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    BorderColor3 = FromRGB(0, 0, 0),
                    AnchorPoint = Vector2New(1, 0),
                    Image = "rbxthumb://type=Asset&w=420&h=420&id=" .. (Data.Icon or "73789337996373"),
                    BackgroundTransparency = 1,
                    Position = UDim2New(1, 0, 0, 0),
                    Size = UDim2New(0, 16, 0, 16),
                    BorderSizePixel = 0,
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                Items["BackdropFrame"] = Instances:Create("Frame", {
                    Parent = Library.Holder.Instance,
                    Name = "Backdrop",
                    BackgroundColor3 = FromRGB(0, 0, 0),
                    BackgroundTransparency = 1,
                ...
                if IsMobile then
                    ...
                    Items["FloatingLogo"] = Instances:Create("ImageLabel", {
                        ...
                        BorderColor3 = FromRGB(0, 0, 0),
                        Name = "\0",
                        Image = "rbxthumb://type=Asset&w=420&h=420&id=" .. Window.Logo,
                        BackgroundTransparency = 1,
                        AnchorPoint = Vector2New(0.5, 0.5),
            ...
            function Window:SetOpen(Bool)
                ...
                if Window.IsOpen then 
                    ...
                    Items["BackdropFrame"].Instance.Visible = true
                end
                ...
                NewTween.Tween.Completed:Connect(function()
                    ...
                    Items["BackdropFrame"].Instance.Visible = Window.IsOpen
                end)
            end
        ...
        Library.Page = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = "rbxthumb://type=Asset&w=420&h=420&id="..Page.Icon,
                    BackgroundTransparency = 1,
        ...
        Library.Pages.Section = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    Size = UDim2New(0, 21, 0, 20),
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = "rbxthumb://type=Asset&w=420&h=420&id="..Section.Icon,
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, 15, 0.5, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0,
            ...
            local Items = { } do 
                ...
                if Button.Icon then 
                    Items["Icon"] = Instances:Create("ImageLabel", {
                        ...
                        Size = UDim2New(0, 18, 0, 18),
                        AnchorPoint = Vector2New(1, 0.5),
                        Image = "rbxthumb://type=Asset&w=420&h=420&id="..Button.Icon,
                        BackgroundTransparency = 1,
